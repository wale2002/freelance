...
// src/pages/DashboardPage.tsx (Updated: Removed Inter font classes; removed stats/metrics cards for Active Projects, Total Bids/Global Bids, and Messages; Added modern profile sidebar)
import { useEffect, useState, useMemo } from "react";
import { useNavigate } from "react-router-dom";
import { motion, AnimatePresence } from "framer-motion";
import { useAuthStore } from "@/stores/authStore";
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <aside className="hidden lg:block w-80 border-l p-6 overflow-y-auto bg-background">
